      ...
      <div className="flex justify-center">
        {lineup.map((lineup, index) => {
          if (lineup.position === "GK") {
            return (
              <div
                className="bg-[#1C6DD0] w-[20px] h-[20px] lg:w-[30px] lg:h-[30px] flex items-center justify-center rounded-full"
                key={index}
              >
            ...
            if (lineup.position === "RB") {
              return (
                <div className="flex justify-center w-[40px]" key={index}>
                  <div className="bg-[#1C6DD0] w-[20px] h-[20px] lg:w-[30px] lg:h-[30px] flex items-center justify-center rounded-full">
                    <p className="text-[10px] lg:text-[13px] font-semibold">
                      {lineup.np}
                    </p>
                  </div>
